...
#[cfg(test)]
mod tests {
    use crate::parser::{parse_string_or_panic, Operator, BinaryOperator, UnaryOperator};
    use crate::eval::{eval_node, Scope};
    use crate::parser::AstNode::{Assignment, Name, Integer, Expression};
    use crate::object::Object;
    use crate::function::{Function, ArgumentList, ParameterList};
    ...
    fn test_multiline_1() {
        ...
        for node in ast {
            assert_eq!(
                eval_node(node, &mut scope).unwrap(),
                Object::Integer(5)
            );
        }
    ...
    fn test_functioncall_1() {
        ...
        scope.set_variable("a".into(), Object::Function(
            Function::Builtin(ParameterList::new(vec![]), |scope|{
                Object::Integer(10)
            })
        ));
    ...
    fn test_functioncall_2() {
        ...
        // create a function called a
        scope.set_variable("a".into(), Object::Function(
            Function::Builtin(ParameterList::new(vec![
                "x".into()
            ]), |scope|{
                match scope.get_variable(&"x".into()) {
                    Some(i) => i,
                    None => Object::None,
                }
            })
